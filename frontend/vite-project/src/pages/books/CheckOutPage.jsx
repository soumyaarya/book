...
const CheckOutPage = () => {
    ...
    const {currentUser} = useAuth();//to do get user from auth
    const {
        register,
        handleSubmit,
        watch,
    ...
    return (
        <section>
            ...
            {...register("name")}                                    type="text" name="name" id="name" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" />
                                        </div>
...
{...register("address")}                                      type="text" name="address" id="address" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="" />
                                        </div>
...
{...register("country")}                                      name="country" id="country" placeholder="Country" className="px-4 appearance-none outline-none text-gray-800 w-full bg-transparent" />
            ...
            {...register("zipcode")} 
                                        ...
                                        <div className="md:col-span-5 mt-3">
                                            <div className="inline-flex items-center">
                                                <input
                  {...register("billing_same")}                                   type="checkbox" name="billing_same" id="billing_same" className="form-checkbox" 
                  checked={isChecked}
